...
newtype CaseInsensitiveNonEmptyString = CaseInsensitiveNonEmptyString
  NonEmptyString
...
instance showCaseInsensitiveNonEmptyString :: Show CaseInsensitiveNonEmptyString where
  show (CaseInsensitiveNonEmptyString s) = "(CaseInsensitiveNonEmptyString "
    <> show s
    <> ")"

derive instance newtypeCaseInsensitiveNonEmptyString ::
